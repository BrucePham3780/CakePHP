...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phoneNum' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'userSessId' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'userSessId' => ['type' => 'index', 'columns' => ['userSessId'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['userId'], 'length' => []],
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['userSessId'], 'references' => ['role', 'userSessId'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'phoneNum' => 'Lorem ipsum dolor sit amet',
                'created' => '2018-11-09 01:57:20',
                'modified' => '2018-11-09 01:57:20',
                'userSessId' => 1
            ],
        ];
        parent::init();
